import { Component, computed, contentChild, input, type Signal } from '@angular/core';
...
export const contextClasses = 'not-prose inline-flex items-center text-muted-foreground text-xs';

@Component({
  selector: 'ai-context,[aiContext]',
  hostDirectives: [BrnHoverCard],
  providers: [
    provideBrnHoverCardDefaultOptions({
      animationDelay: 0,
      hideDelay: 0,
      showDelay: 0,
    }),
