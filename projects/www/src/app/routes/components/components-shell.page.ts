...
import { componentSidebarGroup, componentHref } from '../docs/data/docs-navigation';

@Component({
  imports: [HlmNavigationMenuImports, RouterLink, RouterLinkActive, RouterOutlet],
  template: `
    <section class="docs-layout">
      <aside class="docs-sidebar" aria-label="Components navigation">
        <div class="docs-sidebar-heading text-muted-foreground">
          <span>{{ componentSidebarGroup.title }}</span>
        </div>
...
export class ComponentsShellPage {
