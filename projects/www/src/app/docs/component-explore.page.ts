    ...
    <section class="explore-page" aria-labelledby="components-title">
      <header class="explore-header">
        ...
        <p class="text-muted-foreground">
          Building blocks for AI chat interfaces, agent workflows, tool calls, confirmations,
          reasoning traces, and generated output.
        </p>
      </header>
  ...
  protected readonly componentGroups = [
    {
      ...
      description: 'Primitives for composing AI chat and agent surfaces.',
      items: componentDocs,
    },
  ] as const;
}
